#ifndef SMS_CONSHDLRHOLES_HPP
#define SMS_CONSHDLRHOLES_HPP
...
/** C++ constraint handler for holes (chordless cycles of length >= 4) */
class ConshdlrHoles : public scip::ObjConshdlr {

private:
    Graph const *const sepGraph_;
    HoleSeparator holeSeparator_;
    SCIP_Bool sepaCutpool_;
    SCIP_Real minEfficacy_;

public:

    /** constructor */
    explicit ConshdlrHoles(Scip *scip, const Graph *sepGraph);


    /** destructor */
    ~ConshdlrHoles() override = default;
