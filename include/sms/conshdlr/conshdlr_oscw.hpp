#ifndef SMS_CONSHDLR_OC_FAST_HPP
#define SMS_CONSHDLR_OC_FAST_HPP
...
class ConshdlrOscw : public scip::ObjConshdlr {

private:
    Graph const *const sepGraph_;
    OcwSeparator ocwSeparator_;

    SCIP_Bool sepaCutpool_;

    // Statistics
    uint64_t totalConstructedCycleLength_ = 0;

public:

    /** constructor */
    explicit ConshdlrOscw(Scip *scip, const Graph *sepGraph);


    /** destructor */
    ~ConshdlrOscw() override = default;
...
private:
    ...
    SCIP_RETCODE sepaOddCycles(SCIP *scip,               /**< SCIP data structure */
                               SCIP_CONSHDLR *conshdlr,  /**< the constraint handler itself */
                               SCIP_CONS **/*conss*/,        /**< array of constraints to process */
                               int /*nconss*/,               /**< number of constraints to process */
                               int /*nusefulconss*/,         /**< number of useful (non-obsolete) constraints to process */
                               SCIP_SOL*             sol,  /**< primal CIP solution, nullptr for current LP solution */
                               SCIP_RESULT *result);

    /** separates odd cycle cuts */
    SCIP_RETCODE sepaOddCyclesLp(
...
#endif //SMS_CONSHDLR_OC_FAST_HPP
