#ifndef SMS_CONSHDLRODDSUBSETCYCLES_HPP
#define SMS_CONSHDLRODDSUBSETCYCLES_HPP
...
/** Constraint handler for cycles giving rise to odd-selection cycle constraints */
class ConshdlrOddSubsetCycles : public scip::ObjConshdlr {

private:
    SCIP_Bool enforceCons_;

public:

    /** constructor */
    explicit ConshdlrOddSubsetCycles(Scip *scip);


    /** destructor */
    ~ConshdlrOddSubsetCycles() override = default;
...
private:
    ...
    /** separates odd selection cycle cuts */
    SCIP_RETCODE sepaLp(
...
/** creates and captures an odd-selection cycle constraint */
SCIP_RETCODE SCIPcreateConsCycles(
        SCIP *scip,                   /**< SCIP data structure */
        SCIP_CONS **cons,             /**< pointer to hold the created constraint */
        const char *name,             /**< name of constraint */
        const Graph *graph,           /**< the graph to separate on */
        const OddClosedWalk *ocw,     /**< the odd closed walk to separate on */
...
/** creates and captures an odd-selection cycle constraint */
SCIP_RETCODE SCIPcreateConsBasicCycles(
        SCIP *scip,                   /**< SCIP data structure */
        SCIP_CONS **cons,             /**< pointer to hold the created constraint */
        const char *name,             /**< name of constraint */
        const Graph *graph           /**< the graph to separate on */
...
#endif //SMS_CONSHDLRODDSUBSETCYCLES_HPP
