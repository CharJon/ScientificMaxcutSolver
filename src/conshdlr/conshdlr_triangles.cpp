...
#define CONSHDLR_NAME          "triangles"
#define CONSHDLR_DESC          "triangle constraints"
...
ConshdlrTriangles::ConshdlrTriangles(Scip *scip, const Graph *sepGraph) : scip::ObjConshdlr(scip, CONSHDLR_NAME,
                                                                                            CONSHDLR_DESC,
...
SCIP_RETCODE
ConshdlrTriangles::scip_check(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS ** /*conss*/, int /*nconss*/,
                              SCIP_SOL * /*sol*/,
...
SCIP_RETCODE
ConshdlrTriangles::scip_sepasol(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS ** /*conss*/, int /*nconss*/,
                                int /*nusefulconss*/, SCIP_SOL */*sol*/, SCIP_RESULT */*result*/) {
    throw std::runtime_error("Not implemented: scip_sepasol.");
}

SCIP_RETCODE ConshdlrTriangles::scip_sepalp(SCIP *scip, SCIP_CONSHDLR *conshdlr, SCIP_CONS **conss, int nconss,
                                            int nusefulconss, SCIP_RESULT *result) {
    SCIP_CALL(sepaTrianglesLp(scip, conshdlr, conss, nconss, nusefulconss, result));
    return SCIP_OKAY;
}

SCIP_RETCODE ConshdlrTriangles::sepaTrianglesLp(
    ...
    *result = SCIP_DIDNOTFIND;
    ...
    for (auto e: sepGraph_->edgeRange()) {
        ...
        triangleSeparator_.updateWeights(e.u, e.v, fixedVal);
    }

    auto violatedOcws = triangleSeparator_.getViolatedTriangles();
    ...
    std::cout << "Separated " << separatedCons << " triangle cuts and added " << cutsAdded << " Result is " << *result
...
SCIP_RETCODE ConshdlrTriangles::scip_enfolp(SCIP *scip, SCIP_CONSHDLR *conshdlr, SCIP_CONS **conss, int nconss,
                                            int nusefulconss,
...
SCIP_RETCODE
ConshdlrTriangles::scip_enfops(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/,
...
SCIP_RETCODE
ConshdlrTriangles::scip_lock(SCIP * /*scip*/, SCIP_CONSHDLR * /*conshdlr*/, SCIP_CONS * /*cons*/,
                             SCIP_LOCKTYPE /*locktype*/,
                             int /*nlockspos*/, int /*nlocksneg*/) {
    return SCIP_OKAY;
}

SCIP_RETCODE ConshdlrTriangles::scip_trans(SCIP *scip, SCIP_CONSHDLR *conshdlr, SCIP_CONS *sourcecons,
...
scip::ObjProbCloneable *ConshdlrTriangles::clone(SCIP *scip, SCIP_Bool *valid) const {
    assert(valid != nullptr);
    *valid = true;
    return new ConshdlrTriangles(scip, sepGraph_);
}

SCIP_RETCODE
ConshdlrTriangles::scip_initsol(SCIP */*scip*/, SCIP_CONSHDLR */*conshdlr*/, SCIP_CONS **/*conss*/, int /*nconss*/) {

    auto scc = SmallChordlessCycles(*sepGraph_);
    scc.run();
    for (auto t: scc.triangles) {
        triangleSeparator_.addTriangle(t[0], t[1], t[2]);
    }
